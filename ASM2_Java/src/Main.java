...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (running) {
            ...
            System.out.println("2. Delete student by student code");
            System.out.println("3. Sort students by score in descending order");
            System.out.println("4. Find students by student code or name");
            System.out.println("5. Find the student whose score is greater than x");
    ...
    public static void removeByCode(String code) {
        ...
        if (removed) {
            System.out.println("Students have codes " + code + " has been deleted!");
        } else {
    ...
    public static void sortByGradeDesc() {
        ...
        System.out.println("The student list has been sorted by score in descending order!");
    }
